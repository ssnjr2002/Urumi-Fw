...
```sh
npm install @fablab/cnc-toolpath
```
...
```ts
import { parseConfig, bakePlan } from "@fablab/cnc-toolpath";
...
import { parseConfig, bakePlan, setDOMParser } from "@fablab/cnc-toolpath";
...
```ts
import { loadPlan, savePlan } from "@fablab/cnc-toolpath";
...
```ts
import { scheduleMounts, walkSchedule } from "@fablab/cnc-toolpath";
...
```ts
import { packMicrosegment, writeStream } from "@fablab/cnc-toolpath";
...
Everything below is imported from `@fablab/cnc-toolpath`. This is the whole
