...
class ConfigView(ttk.Frame):
    ...
    def _build_ui(self):
        ...
        self.status_lbl.grid(row=0, column=0, padx=8, pady=8, sticky="w")
        
        # Action Row
        self.load_btn = ttk.Button(self, text="Load Prod Config")
        self.load_btn.grid(row=0, column=1, padx=4, pady=8, sticky="e")
        
        self.load_sim_btn = ttk.Button(self, text="Load Sim Config")
        self.load_sim_btn.grid(row=0, column=2, padx=8, pady=8, sticky="e")
