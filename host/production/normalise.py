...
from host.production.parse import load_svg, CubicBezier
...
def load_svg_mm_subpaths(svg_path):
    ...
    from host.production.parse import load_svg_subpaths
...
def load_svg_mm_layers(svg_path):
    ...
    """
    from host.production.parse import load_svg_layers
